...
+(function () {
        ...
        q = {
          ...
          keyBinds: {
            ...
            right: function () {
              ...
              var a = this._dates[0] || this.getMoment();
              return (
                this.widget.find('.datepicker').is(':visible') && this.date(a.clone().add(1, 'd')),
                !0
              );
            },
            pageUp: function () {
            ...
            pageDown: function () {
              ...
              var a = this._dates[0] || this.getMoment();
              return (
                this.widget.find('.datepicker').is(':visible') && this.date(a.clone().add(1, 'M')),
                !0
              );
            },
            enter: function () {
        ...
        r = (function () {
          ...
          return (
              ...
              if (!a)
                return (
                  this._options.allowMultidate && 1 !== this._dates.length
                    ? ((d = this._element.data('date') + ','),
                      (d = d
                        .replace(c.format(this.actualFormat) + ',', '')
                        .replace(',,', '')
                        .replace(/,\s*$/, '')),
                      this._dates.splice(b, 1),
                      this._datesFormatted.splice(b, 1))
                    : ((this.unset = !0), (this._dates = []), (this._datesFormatted = [])),
                  void 0 !== this.input && (this.input.val(d), this.input.trigger('input')),
                  this._element.data('date', d),
                  this._notifyEvent({ type: r.Event.CHANGE, date: !1, oldDate: c }),
                  void this._update()
                );
              if (
                ((a = a.clone().locale(this._options.locale)),
                this._hasTimeZone() && a.tz(this._options.timeZone),
                1 !== this._options.stepping &&
                  a
                    .minutes(
                      Math.round(a.minutes() / this._options.stepping) * this._options.stepping,
                    )
                    .seconds(0),
                this._isValid(a))
              ) {
                if (
                  ((this._dates[b] = a),
                  (this._datesFormatted[b] = a.format('YYYY-MM-DD')),
                  (this._viewDate = a.clone()),
                  this._options.allowMultidate && this._dates.length > 1)
                ) {
                ...
                (this._options.keepInvalid
                  ? this._notifyEvent({ type: r.Event.CHANGE, date: a, oldDate: c })
                  : void 0 !== this.input &&
                    (this.input.val(
                      '' + (this.unset ? '' : this._dates[b].format(this.actualFormat)),
                    ),
                    this.input.trigger('input')),
                  this._notifyEvent({ type: r.Event.ERROR, date: a, oldDate: c }));
            }),
            ...
            (r.prototype._notifyEvent = function (a) {
              (a.type === r.Event.CHANGE && a.date && a.date.isSame(a.oldDate)) ||
                (!a.date && !a.oldDate) ||
              ...
              this.widget &&
                (a &&
                  (this.currentViewMode = Math.max(
                    ...
                    Math.min(3, this.currentViewMode + a),
                  )),
                this.widget
                  .find('.datepicker > div')
                  .hide()
                  .filter('.datepicker-' + l[this.currentViewMode].CLASS_NAME)
                  .show());
            }),
            ...
            (r.prototype._isValid = function (b, c) {
              ...
              if (
                ...
                'd' === c &&
                this._options.daysOfWeekDisabled.indexOf(b.day()) !== -1
              )
                return !1;
              if (
                this._options.disabledHours &&
                ('h' === c || 'm' === c || 's' === c) &&
                this._isInDisabledHours(b)
              )
                return !1;
              if (
                this._options.enabledHours &&
                ('h' === c || 'm' === c || 's' === c) &&
                !this._isInEnabledHours(b)
              )
                return !1;
            ...
            (r.prototype._parseInputDate = function (a) {
              return (
                void 0 === this._options.parseInputDate
                  ? b.isMoment(a) || (a = this.getMoment(a))
                  : (a = this._options.parseInputDate(a)),
                a
              );
            }),
            (r.prototype._keydown = function (a) {
              ...
              for (c in o)
                o.hasOwnProperty(c) &&
                  o[c] === j &&
                  (g.push(c), parseInt(c, 10) !== i && (h[c] = !0));
              for (c in this._options.keyBinds)
                if (
                  this._options.keyBinds.hasOwnProperty(c) &&
                  'function' == typeof this._options.keyBinds[c] &&
                  ((e = c.split(' ')), e.length === g.length && m[i] === e[e.length - 1])
                ) {
                ...
                (c =
                  void 0 === a || null === a
                    ...
                    : this._hasTimeZone()
                      ...
                      : b(a, this.parseFormats, this._options.locale, this._options.useStrict)),
            ...
            (r.prototype.daysOfWeekDisabled = function (a) {
              ...
              if (
                ((this._options.daysOfWeekDisabled = a
                  .reduce(function (a, b) {
                    return (
                      (b = parseInt(b, 10)),
              ...
              if (this._options.minDate && b.isBefore(this._options.minDate))
                throw new TypeError(
                  'maxDate() date parameter is before this.options.minDate: ' +
                    b.format(this.actualFormat),
                );
              this._options.maxDate = b;
              for (var c = 0; c < this._dates.length; c++)
                this._options.useCurrent &&
                  !this._options.keepInvalid &&
                  this._dates[c].isAfter(a) &&
                  this._setValue(this._options.maxDate, c);
              (this._viewDate.isAfter(b) &&
                (this._viewDate = b.clone().subtract(this._options.stepping, 'm')),
                this._update());
            }),
            (r.prototype.minDate = function (a) {
              ...
              for (var c = 0; c < this._dates.length; c++)
                this._options.useCurrent &&
                  !this._options.keepInvalid &&
                  this._dates[c].isBefore(a) &&
                  this._setValue(this._options.minDate, c);
              (this._viewDate.isBefore(b) &&
                (this._viewDate = b.clone().add(this._options.stepping, 'm')),
                this._update());
            }),
            (r.prototype.defaultDate = function (a) {
              ...
              'string' == typeof a &&
                (a = 'now' === a || 'moment' === a ? this.getMoment() : this.getMoment(a));
              var b = this._parseInputDate(a);
              if (!b.isValid())
            ...
            (r.prototype.collapse = function (a) {
              ...
              return (
                this._options.collapse === a ||
                ((this._options.collapse = a), void (this.widget && (this.hide(), this.show())))
              );
            }),
            ...
            (r.prototype.viewMode = function (a) {
              ...
              if (r.ViewModes.indexOf(a) === -1)
                throw new TypeError(
                  'viewMode() parameter must be one of (' + r.ViewModes.join(', ') + ') value',
                );
              ((this._options.viewMode = a),
                (this.currentViewMode = Math.max(
                  r.ViewModes.indexOf(a) - 1,
                  this.MinViewModeNumber,
                )),
                this._showMode());
            }),
            ...
            (r.prototype.buttons = function (b) {
              ...
              if (
                (a.extend(this._options.buttons, b),
            ...
            (r.prototype.disabledHours = function (b) {
              ...
              if (
                ((this._options.disabledHours = this._indexGivenHours(b)),
            ...
            (r.prototype.enabledHours = function (b) {
              ...
              if (
                ((this._options.enabledHours = this._indexGivenHours(b)),
            ...
            (r.prototype.multidateSeparator = function (a) {
              ...
              if ('string' != typeof a || a.length > 1)
                throw new TypeError(
                  'multidateSeparator expects a single character string parameter',
                );
  ...
  (function (e) {
    var g = e.fn[f.NAME],
      ...
      k = function (a) {
        var b = a.data('target'),
          c = void 0;
        return (
          b || ((b = a.attr('href') || ''), (b = /^#[a-z]/i.test(b) ? b : null)),
          (c = e(b)),
      ...
      l = (function (g) {
        ...
        return (
          ...
          (k.prototype._getDatePickerTemplate = function () {
            var a = e('<thead>').append(
                e('<tr>')
                  .append(
                    e('<th>')
                      .addClass('prev')
                      .attr('data-action', 'previous')
                      .append(e('<span>').addClass(this._options.icons.previous)),
                  )
                  .append(
                    e('<th>')
                  ...
                  .append(
                    e('<th>')
                      ...
                      .append(e('<span>').addClass(this._options.icons.next)),
                  ),
              ),
              b = e('<tbody>').append(
                e('<tr>').append(
                  e('<td>').attr('colspan', '' + (this._options.calendarWeeks ? '8' : '7')),
                ),
              );
            return [
              e('<div>')
                .addClass('datepicker-days')
                .append(e('<table>').addClass('table table-sm').append(a).append(e('<tbody>'))),
              e('<div>')
                .addClass('datepicker-months')
                .append(
                  e('<table>').addClass('table-condensed').append(a.clone()).append(b.clone()),
                ),
              e('<div>')
          ...
          (k.prototype._getTimePickerMainTemplate = function () {
            ...
            return (
                ...
                (a.append(
                  e('<td>').append(
                    e('<a>')
                      ...
                      .append(e('<span>').addClass(this._options.icons.up)),
                  ),
                ),
                b.append(
                  e('<td>').append(
                ...
                c.append(
                  e('<td>').append(
                    e('<a>')
                      ...
                      .append(e('<span>').addClass(this._options.icons.down)),
                  ),
                )),
              this._isEnabled('m') &&
                (this._isEnabled('h') &&
                  (a.append(e('<td>').addClass('separator')),
                  b.append(e('<td>').addClass('separator').html(':')),
              ...
              e('<div>')
                ...
                .append(e('<table>').addClass('table-condensed').append([a, b, c]))
            );
          }),
          ...
          (k.prototype._getToolbar = function () {
            ...
            if (
                ...
                a.push(
                  e('<td>').append(
                    e('<a>')
                      ...
                      .append(e('<span>').addClass(this._options.icons.today)),
                  ),
                ),
              ...
              ('times' === this._options.viewMode
                ? ((b = this._options.tooltips.selectDate), (c = this._options.icons.date))
                : ((b = this._options.tooltips.selectTime), (c = this._options.icons.time)),
                a.push(
                  e('<td>').append(
                    e('<a>')
                      .attr({ href: '#', tabindex: '-1', 'data-action': 'togglePicker', title: b })
            ...
            return (
              ...
              0 === a.length
                ...
                : e('<table>')
                    ...
                    .append(e('<tbody>').append(e('<tr>').append(a)))
            );
          }),
          (k.prototype._getTemplate = function () {
            ...
            return (
              this._options.inline && a.removeClass('dropdown-menu'),
              this.use24Hours && a.addClass('usetwentyfour'),
              this._isEnabled('s') && !this.use24Hours && a.addClass('wider'),
              this._options.sideBySide && this._hasDate() && this._hasTime()
                ? (a.addClass('timepicker-sbs'),
                  'top' === this._options.toolbarPlacement && a.append(f),
                  a.append(
                    e('<div>')
                      .addClass('row')
                      .append(b.addClass('col-md-6'))
                  ...
                  ('bottom' !== this._options.toolbarPlacement &&
                    ...
                    a.append(f),
                  a)
                : ('top' === this._options.toolbarPlacement && d.append(f),
                  this._hasDate() &&
                    d.append(
                      e('<li>')
                  ...
                  'default' === this._options.toolbarPlacement && d.append(f),
                  this._hasTime() &&
                    d.append(
                      e('<li>')
                  ...
                  'bottom' === this._options.toolbarPlacement && d.append(f),
                  a.append(d))
            );
          }),
          (k.prototype._place = function (a) {
            ...
            if (
              ('auto' === c &&
                (c =
                  h.top + 1.5 * b.widget.height() >= e(window).height() + e(window).scrollTop() &&
                  b.widget.height() + b._element.outerHeight() < h.top
                    ? 'top'
                    : 'bottom'),
              'auto' === d &&
                (d =
                  f.width() < h.left + b.widget.outerWidth() / 2 &&
                  h.left + b.widget.outerWidth() > e(window).width()
                    ? 'right'
                    : 'left'),
              'top' === c
                ? b.widget.addClass('top').removeClass('bottom')
                : b.widget.addClass('bottom').removeClass('top'),
              'right' === d
                ? b.widget.addClass('float-right')
                : b.widget.removeClass('float-right'),
              'relative' !== f.css('position') &&
                (f = f
                  .parents()
                  .filter(function () {
            ...
            b.widget.css({
              ...
              bottom:
                'top' === c ? f.outerHeight() - (f === b._element ? 0 : g.top) + 'px' : 'auto',
              left: 'left' === d ? (f === b._element ? 0 : g.left) + 'px' : 'auto',
              right:
                'left' === d
                  ? 'auto'
                  : f.outerWidth() -
                    b._element.outerWidth() -
                    (f === b._element ? 0 : g.left) +
                    'px',
            });
          }),
          (k.prototype._fillDow = function () {
            ...
            for (
              this._options.calendarWeeks === !0 && a.append(e('<th>').addClass('cw').text('#'));
              b.isBefore(this._viewDate.clone().endOf('w'));
            )
          ...
          (k.prototype._fillMonths = function () {
            for (
              var a = [], b = this._viewDate.clone().startOf('y').startOf('d');
              b.isSame(this._viewDate, 'y');
            )
              (a.push(
                e('<span>')
          ...
          (k.prototype._updateMonths = function () {
            ...
            (b.eq(0).find('span').attr('title', this._options.tooltips.prevYear),
              ...
              this._getLastPickedDate().isSame(this._viewDate, 'y') &&
                !this.unset &&
                c.eq(this._getLastPickedDate().month()).addClass('active'),
              c.each(function (a) {
          ...
          (k.prototype._updateYears = function () {
            var a = this.widget.find('.datepicker-years'),
              ...
              f = '';
            for (
              b.eq(0).find('span').attr('title', this._options.tooltips.prevDecade),
                b.eq(1).attr('title', this._options.tooltips.selectDecade),
                b.eq(2).find('span').attr('title', this._options.tooltips.nextDecade),
                a.find('.disabled').removeClass('disabled'),
                this._options.minDate &&
                  this._options.minDate.isAfter(d, 'y') &&
                  b.eq(0).addClass('disabled'),
                b.eq(1).text(d.year() + '-' + e.year()),
                this._options.maxDate &&
                  this._options.maxDate.isBefore(e, 'y') &&
                  b.eq(2).addClass('disabled'),
                f +=
                  '<span data-action="selectYear" class="year old' +
                  (this._isValid(d, 'y') ? '' : ' disabled') +
                  '">' +
                  (d.year() - 1) +
                  '</span>';
              !d.isAfter(e, 'y');
              ...
              ((f +=
                ...
                (d.isSame(this._getLastPickedDate(), 'y') && !this.unset ? ' active' : '') +
                (this._isValid(d, 'y') ? '' : ' disabled') +
                '">' +
                d.year() +
                '</span>'),
          ...
          (k.prototype._updateDecades = function () {
            var a = this.widget.find('.datepicker-decades'),
              ...
              i = '';
            for (
              b.eq(0).find('span').attr('title', this._options.tooltips.prevCentury),
                b.eq(2).find('span').attr('title', this._options.tooltips.nextCentury),
                a.find('.disabled').removeClass('disabled'),
                (0 === d.year() ||
                  (this._options.minDate && this._options.minDate.isAfter(d, 'y'))) &&
                  b.eq(0).addClass('disabled'),
                b.eq(1).text(d.year() + '-' + e.year()),
                this._options.maxDate &&
                  this._options.maxDate.isBefore(e, 'y') &&
              ...
              ((h = d.year() + 11),
                (f =
                  this._options.minDate &&
                  this._options.minDate.isAfter(d, 'y') &&
                  this._options.minDate.year() <= h),
                (g =
                  this._options.maxDate &&
                  this._options.maxDate.isAfter(d, 'y') &&
                  this._options.maxDate.year() <= h),
                (i +=
                  '<span data-action="selectDecade" class="decade' +
                  (this._getLastPickedDate().isAfter(d) && this._getLastPickedDate().year() <= h
                    ? ' active'
                    : '') +
                  (this._isValid(d, 'y') || f || g ? '' : ' disabled') +
                  '" data-selection="' +
                  (d.year() + 6) +
                  '">' +
                  d.year() +
          ...
          (k.prototype._fillDate = function () {
            ...
            if (this._hasDate()) {
              for (
                b.eq(0).find('span').attr('title', this._options.tooltips.prevMonth),
                  b.eq(1).attr('title', this._options.tooltips.selectMonth),
                  b.eq(2).find('span').attr('title', this._options.tooltips.nextMonth),
                  a.find('.disabled').removeClass('disabled'),
                  b.eq(1).text(this._viewDate.format(this._options.dayViewHeaderFormat)),
                  this._isValid(this._viewDate.clone().subtract(1, 'M'), 'M') ||
                    b.eq(0).addClass('disabled'),
                  this._isValid(this._viewDate.clone().add(1, 'M'), 'M') ||
                    b.eq(2).addClass('disabled'),
                  d = this._viewDate.clone().startOf('M').startOf('w').startOf('d'),
                  h = 0;
                h < 42;
                h++
              ) {
                if (
                  (0 === d.weekday() &&
                    ((f = e('<tr>')),
                    this._options.calendarWeeks && f.append('<td class="cw">' + d.week() + '</td>'),
                    c.push(f)),
                  (g = ''),
                  d.isBefore(this._viewDate, 'M') && (g += ' old'),
                  d.isAfter(this._viewDate, 'M') && (g += ' new'),
                  this._options.allowMultidate)
                ) {
                  var i = this._datesFormatted.indexOf(d.format('YYYY-MM-DD'));
                  i !== -1 &&
                    d.isSame(this._datesFormatted[i], 'd') &&
                    !this.unset &&
                    (g += ' active');
          ...
          (k.prototype._fillHours = function () {
            var a = this.widget.find('.timepicker-hours table'),
              ...
              d = e('<tr>');
            for (
              this._viewDate.hour() > 11 && !this.use24Hours && b.hour(12);
              b.isSame(this._viewDate, 'd') &&
              (this.use24Hours ||
                (this._viewDate.hour() < 12 && b.hour() < 12) ||
                this._viewDate.hour() > 11);
            )
              (b.hour() % 4 === 0 && ((d = e('<tr>')), c.push(d)),
                d.append(
                  '<td data-action="selectHour" class="hour' +
                    (this._isValid(b, 'h') ? '' : ' disabled') +
                    '">' +
          ...
          (k.prototype._fillMinutes = function () {
            for (
              var a = this.widget.find('.timepicker-minutes table'),
                b = this._viewDate.clone().startOf('h'),
                c = [],
                d = 1 === this._options.stepping ? 5 : this._options.stepping,
                f = e('<tr>');
              this._viewDate.isSame(b, 'h');
            )
              (b.minute() % (4 * d) === 0 && ((f = e('<tr>')), c.push(f)),
                f.append(
                  '<td data-action="selectMinute" class="minute' +
                    (this._isValid(b, 'm') ? '' : ' disabled') +
                    '">' +
                    b.format('mm') +
                    '</td>',
                ),
          ...
          (k.prototype._fillSeconds = function () {
            for (
              var a = this.widget.find('.timepicker-seconds table'),
                b = this._viewDate.clone().startOf('m'),
                c = [],
                d = e('<tr>');
              this._viewDate.isSame(b, 'm');
            )
              (b.second() % 20 === 0 && ((d = e('<tr>')), c.push(d)),
                d.append(
                  '<td data-action="selectSecond" class="second' +
                    (this._isValid(b, 's') ? '' : ' disabled') +
                    '">' +
                    b.format('ss') +
                    '</td>',
                ),
          ...
          (k.prototype._fillTime = function () {
            ...
            (this.use24Hours ||
              ((a = this.widget.find('.timepicker [data-action=togglePeriod]')),
              (b = this._getLastPickedDate()
                .clone()
                .add(this._getLastPickedDate().hours() >= 12 ? -12 : 12, 'h')),
              a.text(this._getLastPickedDate().format('A')),
              this._isValid(b, 'h') ? a.removeClass('disabled') : a.addClass('disabled')),
              c
            ...
            switch ((b = b || e(a.currentTarget).data('action'))) {
              ...
              case 'selectMonth':
                ...
                (this._viewDate.month(h),
                  this.currentViewMode === this.MinViewModeNumber
                    ? (this._setValue(
                        c.clone().year(this._viewDate.year()).month(this._viewDate.month()),
              ...
              case 'selectYear':
                ...
                (this._viewDate.year(i),
                  this.currentViewMode === this.MinViewModeNumber
                    ? (this._setValue(
                        c.clone().year(this._viewDate.year()),
                        this._getLastPickedDateIndex(),
                      ),
                      this._options.inline || this.hide())
                    : (this._showMode(-1), this._fillDate()),
              ...
              case 'selectDay':
                ...
                var l = k.date(parseInt(e(a.target).text(), 10)),
                  m = 0;
                (this._options.allowMultidate
                  ? ((m = this._datesFormatted.indexOf(l.format('YYYY-MM-DD'))),
                    m !== -1
                      ? this._setValue(null, m)
                      : this._setValue(l, this._getLastPickedDateIndex() + 1))
              ...
              case 'togglePeriod':
                this._setValue(
                  c.clone().add(c.hours() >= 12 ? -12 : 12, 'h'),
                  this._getLastPickedDateIndex(),
                );
                break;
              case 'togglePicker':
                ...
                if (w && w.length) {
                  ...
                  (w.collapse
                    ? (w.collapse('hide'), x.collapse('show'))
                    : (w.removeClass('show'), x.addClass('show')),
                    y.toggleClass(this._options.icons.time + ' ' + this._options.icons.date),
                    y.hasClass(this._options.icons.date)
                      ? u.attr('title', this._options.tooltips.selectDate)
                      : u.attr('title', this._options.tooltips.selectTime));
                }
                break;
              case 'showPicker':
              ...
              case 'selectHour':
                ...
                (this.use24Hours || (c.hours() >= 12 ? 12 !== A && (A += 12) : 12 === A && (A = 0)),
                  this._setValue(c.clone().hours(A), this._getLastPickedDateIndex()),
                  this._isEnabled('a') ||
                  this._isEnabled('m') ||
                  this._options.keepOpen ||
                  this._options.inline
                    ? this._doAction(a, 'showPicker')
                    : this.hide());
                break;
              case 'selectMinute':
                (this._setValue(
                  c.clone().minutes(parseInt(e(a.target).text(), 10)),
                  this._getLastPickedDateIndex(),
                ),
                  this._isEnabled('a') ||
                  this._isEnabled('s') ||
              ...
              case 'selectSecond':
                (this._setValue(
                  c.clone().seconds(parseInt(e(a.target).text(), 10)),
                  this._getLastPickedDateIndex(),
                ),
                  this._isEnabled('a') || this._options.keepOpen || this._options.inline
                    ? this._doAction(a, 'showPicker')
                    : this.hide());
                break;
              case 'clear':
          ...
          (k.prototype.show = function () {
              ...
              void 0 !== this.input.val() && 0 !== this.input.val().trim().length
                ...
                : this.unset &&
                  ...
                  'string' == typeof this._options.useCurrent &&
                    (a = b[this._options.useCurrent](a)),
                  this._setValue(a, 0));
            } else
              this.unset &&
                this._options.useCurrent &&
                ((a = this.getMoment()),
                'string' == typeof this._options.useCurrent && (a = b[this._options.useCurrent](a)),
                this._setValue(a, 0));
            ((this.widget = this._getTemplate()),
              ...
              void 0 !== this.input &&
                ...
                !this.input.is(':focus') &&
                this.input.focus(),
              this._notifyEvent({ type: f.Event.SHOW }));
          }),
          ...
          (k.prototype.toolbarPlacement = function (a) {
            ...
            if (j.indexOf(a) === -1)
              throw new TypeError(
                'toolbarPlacement() parameter must be one of (' + j.join(', ') + ') value',
              );
          ...
          (k.prototype.widgetParent = function (a) {
            ...
            if (
              ...
              null !== a && 'string' != typeof a && !(a instanceof e))
            )
          ...
          (k._jQueryHandleThis = function (a, b, c) {
            ...
            if (
              ('object' === ('undefined' == typeof b ? 'undefined' : d(b)) &&
                e.extend({}, f.Default, b),
              g || ((g = new k(e(a), b)), e(a).data(f.DATA_KEY, g)),
              'string' == typeof b)
            ) {
          ...
          (k._jQueryInterface = function (a, b) {
            return 1 === this.length
              ? k._jQueryHandleThis(this[0], a, b)
              : this.each(function () {
    ...
    return (
      e(document)
        .on(f.Event.CLICK_DATA_API, f.Selector.DATA_TOGGLE, function () {
          var a = k(e(this));
        ...
        .on(f.Event.BLUR, '.' + f.ClassName.INPUT, function (a) {
          var b = k(e(this)),
            c = b.data(f.DATA_KEY);
          0 !== b.length &&
            (c._options.debug || window.debug || l._jQueryInterface.call(b, 'hide', a));
        })
