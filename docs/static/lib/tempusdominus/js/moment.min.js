!(function (e, a) {
  ...
  function oa(e) {
    ...
    return (function (e) {
      for (var a, t, s, n, d = 0; d < e.length; ) {
        for (
          a = (n = da(e[d]).split('-')).length, t = (t = da(e[d + 1])) ? t.split('-') : null;
          0 < a;
        ) {
            ...
            (function (e) {
              ...
              s < 1 || s > Ce(t, d, r)
                ...
                : null != i
                  ...
                  : ((_ = Re(t, s, n, d, r)), (e._a[he] = _.year), (e._dayOfYear = _.dayOfYear));
            })(e),
          null != e._dayOfYear &&
            ((d = ua(e._a[he], s[he])),
  ...
  ((it.add = $a),
    ...
    (it.hasAlignedHourOffset = function (e) {
      return (
        !!this.isValid() && ((e = e ? Sa(e).utcOffset() : 0), (this.utcOffset() - e) % 60 == 0)
      );
    }),
    (it.isDST = function () {
      return (
    ...
    (mt.weekdays = function (e, a) {
      return e
        ? _(this._weekdays)
          ...
          : this._weekdays[this._weekdays.isFormat.test(a) ? 'format' : 'standalone'][e.day()]
        : _(this._weekdays)
          ? this._weekdays
  ...
  ((Rt.isValid = function () {
    ...
    (l.relativeTimeThreshold = function (e, a) {
      return (
        void 0 !== Ft[e] && (void 0 === a ? Ft[e] : ((Ft[e] = a), 's' === e && (Ft.ss = a - 1), !0))
      );
    }),
