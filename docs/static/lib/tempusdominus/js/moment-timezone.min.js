!(function (a, i) {
  ...
  function o(a) {
    ...
    for (i = 0; i < o.length; i++) ((A /= 60), (c += t(o.charCodeAt(i)) * A));
    return c * n;
  }
  function m(a) {
      ...
      A = (function () {
        ...
        for (e = 1; e < 48; e++)
          ((i = new b(new Date(r, e, 1))).offset !== o.offset &&
            ((a = d(o, i)), A.push(a), A.push(new b(new Date(a.at + 6e4)))),
            (o = i));
        for (e = 0; e < 4; e++)
          (A.push(new b(new Date(r + e, 0, 1))), A.push(new b(new Date(r + e, 6, 1))));
        return A;
      })(),
      c = A.length,
      n = (function (a) {
        var i,
          ...
          c = [];
        for (i = 0; i < o; i++)
          for (e in (r = u[a[i].offset] || {})) r.hasOwnProperty(e) && (A[e] = !0);
        for (i in A) A.hasOwnProperty(i) && c.push(s[i]);
        return c;
      })(A),
      t = [];
    for (r = 0; r < n.length; r++) {
      for (e = new M(S(n[r]), c), o = 0; o < c; o++) e.scoreOffsetAt(A[o]);
      t.push(e);
    }
  ...
  function T(a) {
    ...
    for ('string' == typeof a && (a = [a]), i = 0; i < a.length; i++)
      ((o = g((e = (r = a[i].split('|'))[0]))), (c[o] = a[i]), (s[o] = e), z(o, r[2].split(' ')));
  }
  function S(a, i) {
    a = g(a);
    var e,
    ...
    return r instanceof p
      ...
      : 'string' == typeof r
        ? ((r = new p(r)), (c[a] = r))
        : n[a] && i !== S && (e = S(n[a], S))
          ? ((r = c[a] = new p())._set(e), (r.name = s[a]), r)
          : null;
  }
  function P(a) {
    var i, e, r, o;
  ...
  function _(a) {
    (T(a.zones), P(a.links), (C.dataVersion = a.version));
  }
  function k(a) {
    var i = 'X' === a._f || 'x' === a._f;
  ...
  function C(a) {
    ...
    return (r && !A.isMoment(a) && k(o) && o.add(r.parse(o), 'minutes'), o.tz(e), o);
  }
  ((e < 2 || (2 === e && r < 6)) &&
    N(
  ...
  ((A.tz = C),
    ...
    (A.updateOffset = function (a, i) {
      var e,
        r = A.defaultZone;
      (void 0 === a._z &&
        (r && k(a) && !a._isUTC && ((a._d = A.utc(a._a)._d), a.utc().add(r.parse(a), 'minutes')),
        (a._z = r)),
        a._z &&
          ((e = a._z.utcOffset(a)),
          Math.abs(e) < 16 && (e /= 60),
