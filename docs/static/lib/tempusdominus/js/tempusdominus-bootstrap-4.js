...
+(function () {
  ...
  var DateTimePicker = (function ($, moment) {
    ...
    var DateTimePicker = (function () {
      ...
      DateTimePicker.prototype._setValue = function _setValue(targetMoment, index) {
        ...
        if (!targetMoment) {
          if (!this._options.allowMultidate || this._dates.length === 1) {
            ...
            outpValue = outpValue
              .replace(oldDate.format(this.actualFormat) + ',', '')
              .replace(',,', '')
              .replace(/,\s*$/, '');
        ...
        if (this._options.stepping !== 1) {
          targetMoment
            .minutes(
              Math.round(targetMoment.minutes() / this._options.stepping) * this._options.stepping,
            )
            .seconds(0);
        }
        ...
        if (this._isValid(targetMoment)) {
          ...
          if (this._options.allowMultidate && this._dates.length > 1) {
            for (var i = 0; i < this._dates.length; i++) {
              outpValue +=
                '' + this._dates[i].format(this.actualFormat) + this._options.multidateSeparator;
            }
      ...
      DateTimePicker.prototype._notifyEvent = function _notifyEvent(e) {
        if (
          (e.type === DateTimePicker.Event.CHANGE && e.date && e.date.isSame(e.oldDate)) ||
          (!e.date && !e.oldDate)
        ) {
          return;
        }
      ...
      DateTimePicker.prototype._showMode = function _showMode(dir) {
        ...
        if (dir) {
          this.currentViewMode = Math.max(
            ...
            Math.min(3, this.currentViewMode + dir),
          );
        }
        this.widget
          .find('.datepicker > div')
          .hide()
          .filter('.datepicker-' + DatePickerModes[this.currentViewMode].CLASS_NAME)
          .show();
      };
      ...
      DateTimePicker.prototype.daysOfWeekDisabled = function daysOfWeekDisabled(
        _daysOfWeekDisabled,
      ) {
        if (arguments.length === 0) {
        ...
        this._options.daysOfWeekDisabled = _daysOfWeekDisabled
        ...
        if (this._options.minDate && parsedDate.isBefore(this._options.minDate)) {
          throw new TypeError(
            'maxDate() date parameter is before this.options.minDate: ' +
              parsedDate.format(this.actualFormat),
          );
        }
      ...
      DateTimePicker.prototype.useCurrent = function useCurrent(_useCurrent) {
        ...
        if (
          ...
          useCurrentOptions.indexOf(_useCurrent.toLowerCase()) === -1
        ) {
          throw new TypeError(
      ...
      DateTimePicker.prototype.viewMode = function viewMode(_viewMode) {
        ...
        this.currentViewMode = Math.max(
          DateTimePicker.ViewModes.indexOf(_viewMode) - 1,
          this.MinViewModeNumber,
        );
      ...
      DateTimePicker.prototype.disabledTimeIntervals = function disabledTimeIntervals(
      ...
      DateTimePicker.prototype.multidateSeparator = function multidateSeparator(
        _multidateSeparator,
      ) {
        if (arguments.length === 0) {
  ...
  var TempusDominusBootstrap4 = (function ($) {
    ...
    var TempusDominusBootstrap4 = (function (_DateTimePicker) {
      ...
      TempusDominusBootstrap4.prototype._getDatePickerTemplate = function _getDatePickerTemplate() {
        var headTemplate = $('<thead>').append(
          ...
          contTemplate = $('<tbody>').append(
            $('<tr>').append(
              $('<td>').attr('colspan', '' + (this._options.calendarWeeks ? '8' : '7')),
            ),
          );
        ...
        return [
          $('<div>')
            ...
            .append(
              $('<table>').addClass('table table-sm').append(headTemplate).append($('<tbody>')),
            ),
          $('<div>')
      ...
      TempusDominusBootstrap4.prototype._getTimePickerMainTemplate =
        function _getTimePickerMainTemplate() {
          var topRow = $('<tr>'),
            middleRow = $('<tr>'),
            bottomRow = $('<tr>');
          ...
          return $('<div>')
            ...
            .append(
              $('<table>').addClass('table-condensed').append([topRow, middleRow, bottomRow]),
            );
        };
      ...
      TempusDominusBootstrap4.prototype._getTemplate = function _getTemplate() {
        var template = $('<div>').addClass('bootstrap-datetimepicker-widget dropdown-menu'),
          ...
          toolbar = $('<li>')
            .addClass('picker-switch' + (this._options.collapse ? ' accordion-toggle' : ''))
        ...
        if (this._hasDate()) {
          content.append(
            $('<li>')
              .addClass(this._options.collapse && this._hasTime() ? 'collapse' : '')
              .addClass(
                this._options.collapse && this._hasTime() && this._options.viewMode === 'times'
                  ? ''
                  : 'show',
              )
              .append(dateView),
        ...
        if (this._hasTime()) {
          content.append(
            $('<li>')
              .addClass(this._options.collapse && this._hasDate() ? 'collapse' : '')
              .addClass(
                this._options.collapse && this._hasDate() && this._options.viewMode === 'times'
                  ? 'show'
                  : '',
              )
              .append(timeView),
      ...
      TempusDominusBootstrap4.prototype._place = function _place(e) {
        var self = (e && e.data && e.data.picker) || this,
          ...
          parent = void 0;
        var position = (
            self.component && self.component.length ? self.component : self._element
          ).position(),
          offset = (
            self.component && self.component.length ? self.component : self._element
          ).offset();
        ...
        if (vertical === 'auto') {
          ...
          if (
            offset.top + self.widget.height() * 1.5 >= $(window).height() + $(window).scrollTop() &&
        ...
        self.widget.css({
          ...
          bottom:
            vertical === 'top'
              ? parent.outerHeight() - (parent === self._element ? 0 : position.top) + 'px'
              : 'auto',
          left:
            horizontal === 'left' ? (parent === self._element ? 0 : position.left) + 'px' : 'auto',
          right:
            horizontal === 'left'
              ? 'auto'
              : parent.outerWidth() -
      ...
      TempusDominusBootstrap4.prototype._updateYears = function _updateYears() {
        ...
        while (!startYear.isAfter(endYear, 'y')) {
          html +=
            ...
            (startYear.isSame(this._getLastPickedDate(), 'y') && !this.unset ? ' active' : '') +
            (!this._isValid(startYear, 'y') ? ' disabled' : '') +
            '">' +
            startYear.year() +
            '</span>';
      ...
      TempusDominusBootstrap4.prototype._updateDecades = function _updateDecades() {
        ...
        while (!startDecade.isAfter(endDecade, 'y')) {
          ...
          html +=
            ...
            (this._getLastPickedDate().isAfter(startDecade) &&
            this._getLastPickedDate().year() <= endDecadeYear
              ? ' active'
              : '') +
      ...
      TempusDominusBootstrap4.prototype._fillTime = function _fillTime() {
        ...
        if (!this.use24Hours) {
          ...
          newDate = this._getLastPickedDate()
            .clone()
            .add(this._getLastPickedDate().hours() >= 12 ? -12 : 12, 'h');
        ...
        timeComponents
          ...
          .text(this._getLastPickedDate().format('' + (this.use24Hours ? 'HH' : 'hh')));
        timeComponents
          .filter('[data-time-component=minutes]')
          .text(this._getLastPickedDate().format('mm'));
        timeComponents
          .filter('[data-time-component=seconds]')
          .text(this._getLastPickedDate().format('ss'));
      ...
      TempusDominusBootstrap4.prototype._doAction = function _doAction(e, action) {
        ...
        switch (action) {
          case 'next': {
            ...
            this._viewDate.add(
              DateTimePicker.DatePickerModes[this.currentViewMode].NAV_STEP,
              navFnc,
            );
            this._fillDate();
          ...
          case 'selectMonth': {
            ...
            if (this.currentViewMode === this.MinViewModeNumber) {
              this._setValue(
                lastPicked.clone().year(this._viewDate.year()).month(this._viewDate.month()),
      ...
      TempusDominusBootstrap4.prototype.toolbarPlacement = function toolbarPlacement(
        _toolbarPlacement,
      ) {
        if (arguments.length === 0) {
      ...
      TempusDominusBootstrap4.prototype.widgetPositioning = function widgetPositioning(
        _widgetPositioning,
      ) {
        if (arguments.length === 0) {
      ...
      TempusDominusBootstrap4.prototype.widgetParent = function widgetParent(_widgetParent) {
        ...
        if (
          _widgetParent !== null &&
          typeof _widgetParent !== 'string' &&
          !(_widgetParent instanceof $)
        ) {
